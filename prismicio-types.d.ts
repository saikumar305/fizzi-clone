...
export interface SkyDiveSliceDefaultPrimary {
  /**
   * Senetence field in *SkyDive → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: sky_dive.default.primary.senetence
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  senetence: prismic.KeyTextField;
   ...
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: strawberryLemonade
   * - **API ID Path**: sky_dive.default.primary.flavour
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  flavour: prismic.SelectField<
    "strawberryLemonade" | "lemonLime" | "grape" | "watermelon" | "blackCherry",
    "filled"
  >;
}
